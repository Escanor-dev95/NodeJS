...
import { getParticipations, createParticipation, getParticipation, updateParticipation, deleteParticipation, finishParticipation, getParticipationsByChallenge } from '../controllers';
...
router.get('/challenge/:id', authorizeRoles(['owner', 'customer']), getParticipationsByChallenge);
